...
public class MatchResponse {
    ...
    public MatchResponse(Long matchId, UserProfileDto matchedUser, Double score, String status, List<String> commonSkills, String createdAt, Long senderId) {
    ...
    public static class MatchResponseBuilder {
        ...
        public MatchResponse build() {
            return new MatchResponse(matchId, matchedUser, score, status, commonSkills, createdAt, senderId);
        }
    }
}
